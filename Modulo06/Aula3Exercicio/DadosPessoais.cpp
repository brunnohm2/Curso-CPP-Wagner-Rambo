...
void    DadosPessoais::getFullName() const                  {cout<<"Nome Completo:      "<<_firstName<<' '<<_lastName<<endl;}
void    DadosPessoais::getBirthDate()const                  {cout<<"Data de Nascimento: "<<_birthYear<<'-'<<_birthMonth<<'-'<<_birthDay<<endl;}

void    DadosPessoais::getPersonalData()const               {getFullName();getBirthDate();}
