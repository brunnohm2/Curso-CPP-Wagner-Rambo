...
//----
void        sensCurrent::setSensType    (const string &sensType)    {_sensType = sensType;}
string      sensCurrent::getSensType    ()const                     {return _sensType;}
//----
void        sensCurrent::setValorADC    (int valorADC)              {_valorADC = (valorADC >= 0 && valorADC < 1024) ? valorADC : 512;}
int         sensCurrent::getValorADC    ()const                     {return _valorADC;}
//----
void        sensCurrent::setSensID      (unsigned sensID)           {_sensID = sensID;}
unsigned    sensCurrent::getSensID      ()const                     {return _sensID;}
//----
void        sensCurrent::setVref        (double Vref)               {_Vref = Vref;}
double      sensCurrent::getVref        ()const                     {return _Vref;}
//----
